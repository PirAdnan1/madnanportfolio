          ...
          <div className="flex flex-col md:flex-row items-start justify-center gap-20">
            <div className="bg-white p-4 h-[350px] lg:h-[300px]">
              ...
              <p className="max-w-[368px] mt-2">
                ...
                responsive design, interactive features, and optimized
                performance using modern web technologies.
              </p>
            </div>
            <div className="bg-white p-4 h-[350px] lg:h-[300px]">
              <h1 className="md:text-3xl text-xl font-bold max-w-[374px]">
              ...
              <p className="max-w-[368px] mt-2">
                I have designed a pixel-perfect website in Figma, implementing
                all functionalities, ensuring a seamless user experience with
                responsive design, interactive features, and optimized
                performance using modern web technologies.
              </p>
            </div>
