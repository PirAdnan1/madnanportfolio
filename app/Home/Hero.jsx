...
function Hero() {
  ...
  return (
    <Container>
    <div className="flex flex-col md:flex-row items-center justify-center gap-16 mt-16 mx-4 lg:mx-16">
      <div className="order-2 md:order-1">
        ...
        <button className="bg-[#ff6464] text-xl text-white rounded-xl p-3 mt-5 btn" onClick={handleDownload}>Download Resume</button>
      </div>
      <Image src={MyImage} alt="Its Pir Adnan" className="w-[300px] h-[300px] rounded-full order-1 md:order-2" />
    </div>
    </Container>
  );
}
